...
{'Rejuvenation', 'talent(6,3)&!talent(1,3)&lnbuff1(TANK,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals', 'lnbuff1(TANK,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&!talent(1,3)&lnbuff1(HEALER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals', 'lnbuff1(HEALER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&!talent(1,3)&lnbuff1(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals', 'lnbuff1(DAMAGER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&!talent(1,3)&lnbuff2(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals', 'lnbuff2(DAMAGER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&!talent(1,3)&lnbuff3(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals', 'lnbuff3(DAMAGER,Rejuvenation (Germination))'},
...
{'Rejuvenation', 'talent(6,3)&talent(1,3)&lnbuff1(TANK,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals&player.buff(Abundance).count<6', 'lnbuff1(TANK,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&talent(1,3)&lnbuff1(HEALER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals&player.buff(Abundance).count<6', 'lnbuff1(HEALER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&talent(1,3)&lnbuff1(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals&player.buff(Abundance).count<6', 'lnbuff1(DAMAGER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&talent(1,3)&lnbuff2(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals&player.buff(Abundance).count<6', 'lnbuff2(DAMAGER,Rejuvenation (Germination))'},
{'Rejuvenation', 'talent(6,3)&talent(1,3)&lnbuff3(DAMAGER,Rejuvenation (Germination)).health.predicteddtps>rejuvparty.heals&player.buff(Abundance).count<6', 'lnbuff3(DAMAGER,Rejuvenation (Germination))'},
